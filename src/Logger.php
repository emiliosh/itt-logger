    ...
    public function addRecord($level, $message, array $context = array()): bool
    {
        ...
        if (isset($context['exception']) && $context['exception'] instanceof Exception) {
            ...
            $record['context'] = [
                ...
                'trace' => config('ittlogger.exception.trace') ? $exception->getTraceAsString() : []
            ];
        } else {
        ...
        try {
            ...
            if (config('ittlogger.queue.enable')) {
                SendDocuments::dispatch($record)->onQueue(config('ittlogger.queue.name'));
                return true;
            }
